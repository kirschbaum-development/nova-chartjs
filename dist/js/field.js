...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-nova-chartjs', __webpack_require__(3));
    Vue.component('detail-nova-chartjs', __webpack_require__(6));
    Vue.component('form-nova-chartjs', __webpack_require__(9));
});
